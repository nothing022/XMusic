...
- Get your [Necessary Variables](https://github.com/ShahinaAbhi143/ShahinaXMusic/blob/master/sample.env)
...
`git clone https://github.com/ShahinaAbhi143/ShahinaXMusic && cd ShahinaXMusic`
